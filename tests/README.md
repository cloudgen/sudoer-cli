...
| `test_domain_sr.sh` | Convert, JSON samples, queues, submit, Type 1 gate, dest Fence, Type 0 `test-json-format` / `test-well-known-binary` / `fence-test`, dest-written `submit_by`, dest-owned `submit_app` / `submit_version`, live setup body; dest one-off yes/no | **TP-SR-01..18**, **TP-SR-PRIV-01..04**, **TP-SR-INT-01..06**, **TP-SR-HOOK-***, **TP-SR-FENCE-01..15**, **TP-SR-WKBIN-01..10**, **TP-SR-FT-01..07**, **TP-SR-Q-*** |
