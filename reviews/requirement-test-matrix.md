...
| requirement-domain-sudoer-approval | domain | **TP-SR-01..13**, **TP-SR-PRIV-01..03**, **TP-CLI-14**, **TP-SR-INT-01..04**, **TP-SR-Q-01..03** | Type 0 convert/submit **have**; setup live (static); interactive loop **have**; public queues **have** |
